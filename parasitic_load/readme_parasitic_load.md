...
## Background
When a power plant is activated, some of the energy that it produces is lost, as noted in [Wikipedia's article on parasitic loss](https://en.wikipedia.org/wiki/Losses\_in\_electrical\_systems\#Parasitic\_loss\).
