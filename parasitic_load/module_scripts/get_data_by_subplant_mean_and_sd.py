#!/usr/bin/env python
""" Workflow:
- Note the mean and standard deviation of all columns that we'll need to keep
...
DataBySubplant = DataBySubplant.drop(["parasitic_load"], axis=1)
print(DataBySubplant.columns)
exit()
