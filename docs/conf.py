...
release = pkg_resources.get_distribution("rmi.gencost").version
...
# GitHub repo
issues_github_path = "rmi-electricity/gencost"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/rmi-electricity/gencost",
            "html": """
    ...
    "source_repository": "https://github.com/rmi-electricity/gencost/",
    "source_branch": "main",
